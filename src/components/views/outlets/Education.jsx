      ...
      <div className={styles.section_group}>
        <div className={styles.section}>
          <div className={styles.personalInfo}>
            ...
            <p className={styles.content_line}>
              <strong>E. M. Alcino Francisco da Silva</strong> - Fundamental
              (2008)
            </p>
            <p className={styles.content_line}>
              <strong>C. E. Higino da Silveira</strong> - Médio (2010)
            </p>
            <p className={styles.content_line}>
              <strong>Universidade Estácio de Sá</strong> - Bacharel em Direito
              (2024)
            </p>
          </div>
        </div>
        <div className={styles.section}>
          <div className={styles.personalInfo}>
            ...
            <p className={styles.content_line}>
              Análise e Melhoria de Processos (Exército Brasileiro - 2016)
            </p>
          </div>
        </div>
      </div>
      <div className={styles.section}>
        <div className={styles.personalInfo}>
          <p className={styles.paragraph_header}>
            Demais Habilidades e Conhecimentos
          </p>
          ...
          <p className={styles.content_line}>
            ...
            <a
              ...
              target="blank"
              href="https://drive.google.com/file/d/1hV91Y_pBuUgv-q1UJ94GMqh3AzozQjCV/view?usp=drive_link"
            >
